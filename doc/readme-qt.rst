DayTraderCoin-qt: Qt5 GUI for DayTraderCoin
===============================
...
A warning for people using the *static binary* version of DayTraderCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of DayTraderCoin is linked against libdb 5.0 (see also `this Debian issue`_).
