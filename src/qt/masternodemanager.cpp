...
void MasternodeManager::on_removeButton_clicked()
{
    ...
    confirm = QMessageBox::question(this, "Delete Masternodes Node?", "Are you sure you want to delete this Masternodes node configuration?", QMessageBox::Yes|QMessageBox::No);
