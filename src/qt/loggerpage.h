...
#if defined(Q_OS_WIN)
    // Windows: GetDefaultDataDir()\DayTraderCoin
    #define DEBUG_FILEPATH "\\.DayTraderCoin\\debug.log"
#else
#if defined(Q_OS_MAC)
    // Mac: GetDefaultDataDir()/DayTraderCoin
    #define DEBUG_FILEPATH "DayTraderCoin/debug.log"
#else
    // Unix: GetDefaultDataDir()/.daytradercoin
    #define DEBUG_FILEPATH ".daytradercoin/debug.log"
#endif
#endif
