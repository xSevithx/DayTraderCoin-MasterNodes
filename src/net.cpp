...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("DayTraderCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("DayTraderCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("DayTraderCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DayTraderCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"162.243.186.176", "162.243.186.176" },
    {"159.203.106.65", "159.203.106.65"},
    {"159.203.109.115", "159.203.109.115" },
    {"104.131.2.43", "159.203.109.115" },
    {"104.131.34.150", "159.203.109.115" },
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("DayTraderCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DayTraderCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("DayTraderCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DayTraderCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DayTraderCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("DayTraderCoin-start");
